		...
		return (
			<div>
				...
				<div id="btn-panel" style={{display: this.props.showBtn ? 'block' : 'none'}}>
					<div className="submit-btn" data-degree="5" style={{"backgroundColor":"#FF8200"}}>非常满意</div>
					<div className="submit-btn" data-degree="3" style={{"backgroundColor":"#e89c4c"}}>满意</div>
					<div className="submit-btn" data-degree="1" style={{"backgroundColor":"#e6b581"}}>有待改进</div>
				</div>
...
$(document).ready(function () {
	console.log('Begin.');
	var props = {
		backgroundImage: "20160908vote_dy.jpg",
		width:           '600px',
		height:          '3061px',
		showBtn:         false
	};
